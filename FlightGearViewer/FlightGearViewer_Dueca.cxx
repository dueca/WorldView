...
const ParameterTable* FlightGearViewer_Dueca::getParameterTable()
{
  static const ParameterTable parameter_table[] = {
    ...
    { "receiver", new VarProbe<FlightGearViewer_Dueca, string>
      (&FlightGearViewer_Dueca::receiver),
      "IP address for the flightgear process" },
    
    { "own_interface", new VarProbe<FlightGearViewer_Dueca, string>
      (&FlightGearViewer_Dueca::own_interface), 
      "IP address of own interface, empty to bind to all interfaces" },

    { "port", new VarProbe<FlightGearViewer_Dueca, int>
      (&FlightGearViewer_Dueca::port), 
      "Port to be used" },
    ...
    { "binary-packets", new VarProbe<FlightGearViewer_Dueca,bool>
      (&FlightGearViewer_Dueca::binary_packets), 
      "Use binary packets for sending and receiving" },

    { "mp-host", new VarProbe<FlightGearViewer_Dueca, string>
      (&FlightGearViewer_Dueca::mp_hostip), 
      "IP address of the multiplayer server" },
    
    { "mp-port", new VarProbe<FlightGearViewer_Dueca, int>
    ...
    { "model-table", 
      ...
      "Set the link between simulation class name, and FlightGear model\n"
      "and livery file name (3 strings)" },
...
bool FlightGearViewer_Dueca::complete()
{
  return FlightGearViewer::complete();
}
...
// script access macro
SCM_FEATURES_NOIMPINH(FlightGearViewer_Dueca, ScriptCreatable, "flight-gear-viewer");
...
#else
static CoreCreator<FlightGearViewer_Dueca> a(FlightGearViewer_Dueca::getParameterTable());
#endif
