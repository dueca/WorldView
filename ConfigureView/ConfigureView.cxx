...
const ParameterTable *ConfigureView::getMyParameterTable()
{
  static const ParameterTable parameter_table[] = {
    { "set-timing",
      new MemberCall<ConfigureView, TimeSpec>(&ConfigureView::setTimeSpec),
      set_timing_description },

    { "check-timing",
      new MemberCall<ConfigureView, vector<int>>(&ConfigureView::checkTiming),
...
bool ConfigureView::complete()
{
  ...
  viewcontrol.readGladeFile(
    "../../../../WorldView/ConfigureView/configureview.glade", "configureview",
    this, controls);
#else
