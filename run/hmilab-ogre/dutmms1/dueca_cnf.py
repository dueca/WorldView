...
no_of_nodes = 3                        # total number of nodes used
...
if_address = "dutmms1"          # address of own ip interface
mc_address = "224.0.0.1"        # multicast address
master_address = "dutmms1"      # hostname or address comm master
