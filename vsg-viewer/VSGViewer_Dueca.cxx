...
class objects. Please also add a description (c-style string). */
    ...
    { "set-mask",
      new MemberCall<_ThisObject_, string>(&_ThisObject_::setMaskImage),
      "Set a png image overlay for this viewport" },
...
bool VSGViewer_Dueca::setMaskImage(const std::string &image)
{
  build_view_spec.overlay = image;
  return true;
}
...
SCM_FEATURES_NOIMPINH(vsgviewer::VSGViewer_Dueca, ScriptCreatable,
                      "vsg-viewer-dueca");
